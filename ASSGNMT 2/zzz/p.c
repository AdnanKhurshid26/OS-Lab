...
// struct ConsumerPIDs *cosumerPIDs;
int *total;
...
int main()
{
    ...
    // Init buffer
    buffer = (struct Buffer*)mmap(NULL, sizeof *buffer, PROT_READ | PROT_WRITE, MAP_SHARED | MAP_ANONYMOUS, -1, 0);
    total = (int *)mmap(NULL, sizeof *total, PROT_READ | PROT_WRITE, MAP_SHARED | MAP_ANONYMOUS, -1, 0);
    noOfProducersExited = (int *)mmap(NULL, sizeof *total, PROT_READ | PROT_WRITE, MAP_SHARED | MAP_ANONYMOUS, -1, 0);
